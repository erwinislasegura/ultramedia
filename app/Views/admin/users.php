<div class="content users-content">
    <section class="title">
        ...
        <button type="button" class="admin-primary" data-open="userModal" data-create-user>+ NUEVO USUARIO</button>
    </section>
    ...
    <section class="panel roles-panel">
        ...
        <div class="roles-list">
            <?php foreach($roles as $r):
                ...
                $roleData=['id'=>(int)$r['id'],'name'=>$r['name'],'permissions'=>$rolePermissions,'is_system'=>(bool)$r['is_system']];
            ?>
...
<div class="admin-modal" id="userModal"><div>
...
<div class="admin-modal" id="roleModal"><div>
    ...
    <form method="post" action="<?= url('admin/roles/guardar') ?>">
        ...
        <label>NOMBRE DEL ROL<input name="name" id="roleName" maxlength="80" required></label>
