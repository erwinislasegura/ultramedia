...
(1,'Set · Sprint en la cumbre','184',1,1,19990),(1,'Set · Equipo en ruta','214',1,1,19990),
(2,'Set · Charla previa','81',1,1,24990),(3,'Set · Ascenso final','302',1,1,21990),
(1,'Set · Meta maratón','415',1,1,19990),(2,'Set · Control del balón','128',1,1,24990),
(3,'Set · Curva técnica','219',1,1,21990),(1,'Set · Corrida nocturna','340',1,1,19990),
(2,'Set · Básquet urbano','96',1,1,24990),(3,'Set · Pelotón compacto','511',1,1,21990),
(1,'Set · Último kilómetro','73',1,1,19990),(2,'Set · Celebración final','57',1,1,24990);
INSERT INTO photos(event_id,set_id,title,bib_number,price,original_path,preview_path,file_size) VALUES
(1,1,'Sprint en la cumbre','184',4990,'assets/descarga-demo.txt','https://images.unsplash.com/photo-1552674605-db6ffd4facb5?auto=format&fit=crop&w=900&q=85',5242880),
(1,2,'Equipo en ruta','214',4990,'assets/descarga-demo.txt','https://images.unsplash.com/photo-1540539234-c14a20fb7c7b?auto=format&fit=crop&w=900&q=85',4980736),
(2,3,'Charla previa','81',4990,'assets/descarga-demo.txt','https://images.unsplash.com/photo-1526232761682-d26e03ac148e?auto=format&fit=crop&w=900&q=85',5767168),
(3,4,'Ascenso final','302',4990,'assets/descarga-demo.txt','https://images.unsplash.com/photo-1541625602330-2277a4c46182?auto=format&fit=crop&w=900&q=85',6291456),
(1,5,'Meta maratón','415',4990,'assets/descarga-demo.txt','https://images.unsplash.com/photo-1476480862126-209bfaa8edc8?auto=format&fit=crop&w=900&q=85',5120000),
(2,6,'Control del balón','128',4990,'assets/descarga-demo.txt','https://images.unsplash.com/photo-1574629810360-7efbbe195018?auto=format&fit=crop&w=900&q=85',6100000),
(3,7,'Curva técnica','219',4990,'assets/descarga-demo.txt','https://images.unsplash.com/photo-1511994298241-608e28f14fde?auto=format&fit=crop&w=900&q=85',5900000),
(1,8,'Corrida nocturna','340',4990,'assets/descarga-demo.txt','https://images.unsplash.com/photo-1517963879433-6ad2b056d712?auto=format&fit=crop&w=900&q=85',4800000),
(2,9,'Básquet urbano','96',4990,'assets/descarga-demo.txt','https://images.unsplash.com/photo-1546519638-68e109498ffc?auto=format&fit=crop&w=900&q=85',5600000),
(3,10,'Pelotón compacto','511',4990,'assets/descarga-demo.txt','https://images.unsplash.com/photo-1486218119243-13883505764c?auto=format&fit=crop&w=900&q=85',6300000),
(1,11,'Último kilómetro','73',4990,'assets/descarga-demo.txt','https://images.unsplash.com/photo-1592656094267-764a45160876?auto=format&fit=crop&w=900&q=85',5100000),
(2,12,'Celebración final','57',4990,'assets/descarga-demo.txt','https://images.unsplash.com/photo-1534158914592-062992fbe900?auto=format&fit=crop&w=900&q=85',5450000);
