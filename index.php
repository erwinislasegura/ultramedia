...
foreach([
 ...
 ['GET','/carrito','CartController@index'],['POST','/carrito/agregar','CartController@add'],['POST','/carrito/agregar-varias','CartController@addMany'],['POST','/carrito/eliminar','CartController@remove'],
